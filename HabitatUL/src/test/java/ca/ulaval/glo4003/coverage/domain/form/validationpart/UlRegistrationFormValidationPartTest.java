...
public class UlRegistrationFormValidationPartTest {
  ...
  public abstract static class TestCase {
    ...
    private UlRegistrationFormValidationPart subject;
    ...
    public void setUp() {
      ...
      subject = new UlRegistrationFormValidationPart(ulRegistrarOffice);
    }
