...
public class QuoteFormDtoMatcher extends TypeSafeMatcher<QuoteFormDto> {
  ...
  public static QuoteFormDto getQuoteFormDtoMockitoMatcher(final QuoteRequest quoteRequest) {
    return MockitoHamcrest.argThat(getQuoteFormDtoMatcher(quoteRequest));
  }

  public static QuoteFormDtoMatcher getQuoteFormDtoMatcher(final QuoteRequest quoteRequest) {
