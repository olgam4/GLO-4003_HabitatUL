...
public class RoommateFormulaPartTest {
  ...
  private static final GenderInput GENDER = createGenderInput();
  private static final GenderInput ANOTHER_GENDER = createGenderInput();
  ...
  private GenderInput additionalInsuredGender;
  private Money expectedPremiumAdjustment;

  public RoommateFormulaPartTest(
      String title, GenderInput roommateGender, Money expectedPremiumAdjustment) {
  ...
  @Before
  public void setUp() {
    when(roommateAdjustmentProvider.getAdjustment(any(GenderInput.class), any(GenderInput.class)))
