...
public class AuthorityNumberDeserializationResource {
  @POST
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getDeserialization(AuthorityNumberDeserializationRequest request) {
    return Response.ok().build();
  }

  public static class AuthorityNumberDeserializationRequest {
    public AuthorityNumber value;
  }
}
