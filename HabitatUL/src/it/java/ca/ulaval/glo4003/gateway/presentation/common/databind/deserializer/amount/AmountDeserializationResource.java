...
public class AmountDeserializationResource {
  @POST
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getDeserialization(AmountDeserializationRequest request) {
    return Response.ok().build();
  }

  public static class AmountDeserializationRequest {
    public Amount value;
  }
}
