...
public class CycleDeserializationResource {
  @POST
  @Consumes(MediaType.APPLICATION_JSON)
  public Response getDeserialization(CycleDeserializationRequest request) {
    return Response.ok().build();
  }

  public static class CycleDeserializationRequest {
    public Cycle value;
  }
}
